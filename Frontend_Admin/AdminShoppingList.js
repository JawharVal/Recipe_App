...
const AdminShoppingList = ({ userId, userName, token, onClose }) => {
    ...
    const fetchItems = async () => {
        try {
            const response = await axios.get(`http://localhost:8081/api/admin/users/${userId}/shopping-list`,
    ...
    const handleAddItem = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`http://localhost:8081/api/admin/users/${userId}/shopping-list`,
                newItem,
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const handleUpdateItem = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:8081/api/admin/users/${userId}/shopping-list/${editingItem.id}`,
                editingItem,
                { headers: { Authorization: `Bearer ${token}` } }
            );
            setEditingItem(null);
    ...
    const handleDeleteItem = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:8081/api/admin/users/${userId}/shopping-list/${id}`,
                { headers: { Authorization: `Bearer ${token}` } }
            );
            fetchItems();
        } catch (error) {
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            ...
            await axios.delete(`http://localhost:8081/api/admin/users/${userId}/shopping-list/bulk`,
                {
                    data: ids,
                    headers: { Authorization: `Bearer ${token}` },
                }
...
/**
 ...
 const AdminShoppingList = ({ userId, userName, token, onClose }) => {
    ...
    const fetchItems = async () => {
        try {
            const response = await axios.get(`${API_URL}/api/admin/users/${userId}/shopping-list`,
                { headers: { Authorization: `Bearer ${token}` } }
            );
            setItems(response.data);
        } catch (error) {
    ...
    const handleAddItem = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`${API_URL}/api/admin/users/${userId}/shopping-list`,
                newItem,
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const handleUpdateItem = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`${API_URL}/api/admin/users/${userId}/shopping-list/${editingItem.id}`,
                editingItem,
                { headers: { Authorization: `Bearer ${token}` } }
            );
            setEditingItem(null);
    ...
    const handleDeleteItem = async (id) => {
        if (!window.confirm("Are you sure you want to delete this item?")) return;
        try {
            await axios.delete(`${API_URL}/pi/admin/users/${userId}/shopping-list/${id}`,
                { headers: { Authorization: `Bearer ${token}` } }
            );
            fetchItems();
        } catch (error) {
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            const ids = items.map((item) => item.id);
            await axios.delete(`${API_URL}/api/admin/users/${userId}/shopping-list/bulk`,
                {
                    data: ids,
                    headers: { Authorization: `Bearer ${token}` },
                }
